...
class ClinicalStaffPatientRecordController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('clinical-staff.patient-records.index', [
            'records' => $records,
            'search' => $search,
        ]);
    }
    ...
    public function show(Patient $patient): View
    {
        ...
        return view('clinical-staff.appointments.patient-record.show', compact(
            'patient',
            'appointments',
            'myAppointments',
            'lastVisit',
