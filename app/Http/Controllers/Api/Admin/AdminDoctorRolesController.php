...
class AdminDoctorRolesController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'data' => $paginator->getCollection()->map(fn (DoctorRole $r) => $this->rolePayload($r))->values(),
    ...
    {
        return response()->json([
            'permission_groups' => DoctorPermissions::groups(),
        ]);
    }
    ...
    private function resolveRoleValue(string $roleValueInput, string $name): string
    {
        ...
        return DoctorPermissions::normalizeRole($source);
    }

    /**
     * @return array<string, mixed>
     */
    private function rolePayload(DoctorRole $role): array
    {
