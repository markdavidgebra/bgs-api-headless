...
@php
  ...
  $draftName = old('name', 'New membership plan');
  $planInitial = strtoupper(\Illuminate\Support\Str::substr($draftName, 0, 1));
  $selectedIds = collect(old('included_service_ids', []))->map(fn ($v) => (string) $v)->all();
@endphp
...
@section('content')
    ...
    <div class="container-xl">
      <div class="row align-items-center g-3">
        ...
        <div class="col">
          ...
          <h2 class="page-title mb-0">{{ $draftName }}</h2>
          <div class="text-secondary small mt-1">Create a membership plan on one page — basic info, pricing, included
            services, rules, and notes.</div>
        </div>
        <div class="col-auto ms-auto d-print-none">
          <div class="btn-list">
            <a href="{{ route('admin.subscriptions') }}" class="btn">Cancel</a>
            <button type="submit" form="subscription-create-form" class="btn btn-primary">Save plan</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="page-body">
    <div class="container-xl">
      <div class="row g-3">
        <div class="col-lg-8">
          <form id="subscription-create-form" method="POST" action="{{ route('admin.subscriptions.store') }}">
            @csrf
                ...
                <div class="row g-3">
                  <div class="col-md-6">
                    ...
                    <input id="name" name="name" type="text" class="form-control @error('name') is-invalid @enderror"
                      value="{{ old('name') }}" required placeholder="e.g. Glow Monthly">
                  ...
                  <div class="col-md-6">
                    ...
                    <input id="type" name="type" type="text" class="form-control @error('type') is-invalid @enderror"
                      value="{{ old('type') }}" placeholder="e.g. Membership">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <input id="duration_value" name="duration_value" type="number" min="1" step="1"
                      ...
                      value="{{ old('duration_value') }}" placeholder="Optional">
                  ...
                  <div class="col-md-6">
                    ...
                    <select id="duration_type" name="duration_type"
                      ...
                      <option value="">—</option>
                      <option value="month" @selected(old('duration_type') === 'month')>Month</option>
                      <option value="year" @selected(old('duration_type') === 'year')>Year</option>
                    </select>
                    ...
                    <div class="d-flex flex-column gap-2 mb-2">
                      <label class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" name="rollover_unused_sessions" value="1"
                          @checked((string) old('rollover_unused_sessions', '0') === '1')>
                      ...
                      <label class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" name="cancellation_allowed" value="1"
                          @checked((string) old('cancellation_allowed', '0') === '1')>
                      ...
                      <label class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" name="pause_allowed" value="1"
                          @checked((string) old('pause_allowed', '0') === '1')>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-12">
                    ...
                    <textarea id="aftercare" name="aftercare" rows="3"
                      class="form-control @error('aftercare') is-invalid @enderror">{{ old('aftercare') }}</textarea>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <ul class="text-secondary mb-0 ps-3">
                ...
                <li>Optional slug, category, duration, and usage cap.</li>
            ...
            <div class="card-body">
              <div class="datagrid mb-0">
                <div class="datagrid-item">
                  ...
                  <div class="datagrid-content">{{ ucfirst(old('billing_cycle', '—')) }}</div>
                </div>
                <div class="datagrid-item">
                ...
                <div class="datagrid-item">
                  ...
                  <div class="datagrid-content">₱{{ number_format((float) old('price', 0), 2) }}</div>
                </div>
              </div>
            </div>
          </div>
