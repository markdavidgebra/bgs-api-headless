    ...
    <div class="container-xl">
      <div class="row align-items-center g-3">
        <div class="col">
          ...
          <h2 class="page-title mb-0">Product detail page header</h2>
          <div class="text-secondary small mt-1">Background image behind the title on individual product pages (<code>/our-products/{slug}</code>).</div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row g-3">
        ...
        <div class="col-12 col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              <form method="POST" action="{{ route('admin.page-headers.product-show.update') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
              ...
              @if ($currentPath)
                ...
                <form method="POST" action="{{ route('admin.page-headers.product-show.reset') }}" onsubmit="return confirm('Reset to the default header image?');">
                  @csrf
