    ...
    <div class="container-xl">
      <div class="row align-items-center g-3">
        <div class="col">
          ...
          <h2 class="page-title mb-0">Doctors page header</h2>
          <div class="text-secondary small mt-1">Background image behind the title on the public Doctors listing page (<code>/doctor</code>).</div>
        </div>
      </div>
    </div>
  </div>
