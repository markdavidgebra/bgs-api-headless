    ...
    <div class="container-xl">
      <div class="row align-items-center g-3">
        <div class="col">
          ...
          <h2 class="page-title mb-0">{{ old('title', 'New blog post') }}</h2>
          <div class="text-secondary small mt-1">Create a blog post for the frontend blog listing.</div>
        </div>
        <div class="col-auto ms-auto d-print-none">
          <div class="btn-list">
            <a href="{{ route('admin.blogs') }}" class="btn">Cancel</a>
            <button type="submit" form="blog-create-form" class="btn btn-primary">Save post</button>
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-12">
                    ...
                    <input id="slug" type="text" class="form-control bg-secondary-lt @error('slug') is-invalid @enderror"
                      value="{{ old('slug', old('title') ? \Illuminate\Support\Str::slug(old('title')) : '') }}" disabled>
                    <input type="hidden" name="slug" id="slug-hidden"
                      value="{{ old('slug', old('title') ? \Illuminate\Support\Str::slug(old('title')) : '') }}">
                    <div class="form-hint">Generated from title automatically.</div>
                    @error('slug')
                  ...
                  <div class="col-12">
                    ...
                    <textarea id="excerpt" name="excerpt" rows="3"
                      ...
                      placeholder="Short preview text">{{ old('excerpt') }}</textarea>
                    @error('excerpt')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
