      ...
      <ul class="navbar-nav pt-lg-3">
        ...
        <li class="nav-item dropdown {{ request()->routeIs('admin.slides*') || request()->routeIs('admin.blogs*') || request()->routeIs('admin.faqs*') || request()->routeIs('admin.testimonials*') || request()->routeIs('admin.abouts*') || request()->routeIs('admin.page-headers*') ? 'active' : '' }}">
          ...
          <div class="dropdown-menu">
            ...
            <a class="dropdown-item {{ request()->routeIs(['admin.page-headers.doctor-details', 'admin.page-headers.doctor-details.update', 'admin.page-headers.doctor-details.reset']) ? 'active' : '' }}" href="{{ route('admin.page-headers.doctor-details') }}">Clinical staff details</a>
        ...
        @endif
        @if ($can('clinical_staff.view') || $can('clinical_staff.manage'))
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('admin.clinical-staff*') ? 'active' : '' }}" href="{{ route('admin.clinical-staff') }}">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
