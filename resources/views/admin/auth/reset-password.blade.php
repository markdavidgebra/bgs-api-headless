        ...
        <div class="card-body">
          ...
          <form action="{{ route('admin.password.store') }}" method="POST" autocomplete="off" novalidate>
            ...
            <div class="mb-3">
              ...
              <input type="email" name="email" value="{{old('email', $request->email)}}" class="form-control" placeholder="your@email.com" autocomplete="off" required>
            ...
            <div class="mb-2">
              ...
              <div class="input-group input-group-flat">
                <input type="password" class="form-control confirm-password" name="password_confirmation" placeholder="Your password" autocomplete="off" required>
