...
@section('content')
    ...
    <div class="container-xl">
      <div class="row g-2 align-items-center">
        <div class="col">
          ...
          <div class="text-secondary small mt-1">Create a role that can be assigned to admin users.</div>
        </div>
        <div class="col-auto ms-auto d-print-none">
          <div class="btn-list">
            <a href="{{ route('admin.roles.index') }}" class="btn">Cancel</a>
            <button type="submit" form="role-create-form" class="btn btn-primary">Save role</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="page-body">
    <div class="container-xl">
      <form id="role-create-form" method="POST" action="{{ route('admin.roles.store') }}">
        @csrf
        <div class="card">
          <div class="card-body">
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <input id="role_value" type="text" name="role_value" class="form-control @error('role_value') is-invalid @enderror"
                  value="{{ old('role_value') }}" placeholder="e.g. content manager">
              ...
              <div class="col-12">
                ...
                <textarea id="description" name="description" rows="3" class="form-control @error('description') is-invalid @enderror"
                  placeholder="Optional role notes">{{ old('description') }}</textarea>
                @error('description')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
