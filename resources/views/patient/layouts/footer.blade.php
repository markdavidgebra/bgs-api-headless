                    ...
                    <div class="col-xl-3">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                            ...
                            <div class="logo mb-30">
                                <a href="{{ route('home') }}" class="mb-15"><img src="{{ asset('imgs/theme/bgs.png') }}"
                                        alt="logo" /></a>
                                <p class="font-lg text-heading">Awesome eCommerce store website template</p>
                            </div>
                            <ul class="contact-infor">
                                <li><img src="{{ asset('imgs/theme/bgs.png') }}" alt="" /><strong>Address:
                                    </strong> <span>233 North Michigan Avenue, Suite 1800, Chicago, IL 60601</span>
                                </li>
                                <li><img src="{{ asset('imgs/theme/bgs.png') }}" alt="" /><strong>Call
                                        Us:</strong><span>+9625415 546666464</span></li>
                                <li><img src="{{ asset('imgs/theme/bgs.png') }}"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
                    <div class="hotline d-lg-inline-flex">
                        <img src="{{ asset('imgs/theme/bgs.png') }}" alt="hotline" />
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 text-end d-none d-md-block">
                    <div class="mobile-social-icon">
                        <h6>Follow Us</h6>
                            <a href="#"><img src="{{ asset('imgs/theme/bgs.png') }}" alt="" /></a>
                            <a href="#"><img src="{{ asset('imgs/theme/bgs.png') }}" alt="" /></a>
                            <a href="#"><img src="{{ asset('imgs/theme/bgs.png') }}" alt="" /></a>
                    </div>
