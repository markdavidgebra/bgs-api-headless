                ...
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="header-nav d-none d-lg-flex">
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            @php
                                $headerProductCategories = \App\Models\ProductCategory::query()
                                    ->with([
                            ...
                            <div
                                ...
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        @forelse ($headerProductCategories as $category)
                                            <li>
                                                <a href="{{ route('our-products', ['category' => $category->id]) }}">
                                                    {{ $category->name }}
                                                </a>
                                                @if ($category->products->isNotEmpty())
                                                    <ul>
                                                        @foreach ($category->products as $categoryProduct)
                                                            <li>
                                                                <a href="{{ route('our-products.show', $categoryProduct->slug) }}">{{ $categoryProduct->name }}</a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                @endif
                                ...
                                <a href="{{ route('our-products') }}" class="more_categories">
                                    view all
