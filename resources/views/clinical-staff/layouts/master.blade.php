...
<head>
    ...
    @endphp
    <meta charset="utf-8" />
    <title>@yield('title', 'Clinical Staff Dashboard')</title>
...
<body class="doctor-portal">
    @include('clinical-staff.layouts.header')
    @include('clinical-staff.layouts.mobile-view')
    <!--End header-->

    @yield('content')

    @include('clinical-staff.layouts.footer')
    <!-- Preloader Start -->
