    ...
    <div class="page-header breadcrumb-wrap">
      <div class="container">
        <div class="breadcrumb">
          ...
          <span></span> Clinical staff <span></span> Patient Details
        </div>
      </div>
    </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-center pt-0">
          ...
          <p class="text-secondary mb-3 small">
            {{ __('Treatment notes can only be added after a manager has approved the appointment.') }}
          </p>
          ...
          <p class="text-muted mt-3 mb-0 small">{{ __('A manager must approve this appointment before you can add a note.') }}</p>
        </div>
