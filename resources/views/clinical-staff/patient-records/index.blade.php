                    ...
                    <div class="card-body">
                      <form method="GET" action="{{ route('clinical_staff.patient-records') }}" class="row g-3 align-items-end">
                        ...
                        <div class="col-md-4 d-flex gap-2">
                          ...
                          <a href="{{ route('clinical_staff.patient-records') }}" class="btn btn-sm record-btn record-btn-light">Reset</a>
                        </div>
                      </form>
                    </div>
                  </div>
                          ...
                          <tbody>
                            @forelse ($records as $record)
                              <tr>
                                ...
                                <td>
                                  <a href="{{ route('clinical_staff.patient-records.show', $record->patient->id) }}"
